...
mp = Team.new(name:"Mineola Portuguese",town:"Mineola,NY",coach: "Jonathan Ghandforoush", formation_id:four_four_two.id)
port = Team.new(name:"Portland Timbers", town: "Portland, Oregon", coach:"Giovanni Savarese", formation_id: four_two_three_one.id)
nufc = Team.new(name:"Newcastle United", town:"Newcastle Upon Tyne, UK", coach:"Steve Bruce", formation_id:four_five_one.id)
